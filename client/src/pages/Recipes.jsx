...
const Recipes = () => {
  ...
  if (error) {
    return (
      <div className="min-h-[calc(100vh-72px)] bg-[#fffaf5] px-6 py-14 text-center">
        <p className="mx-auto max-w-xl rounded-[10px] border border-red-100 bg-white px-5 py-4 font-semibold text-red-500 shadow-sm">
          {error}
        </p>
      </div>
    );
  ...
  if (recipes.length === 0 && !searchQuery.trim()) {
    return (
      <div className="min-h-[calc(100vh-72px)] bg-[#fffaf5] px-6 py-14 text-center">
        <p className="mx-auto max-w-xl rounded-[10px] border border-[#efe7dd] bg-white px-5 py-4 font-semibold text-[#3d465a] shadow-sm">
  ...
  return (
    <div className="min-h-[calc(100vh-72px)] w-screen max-w-full overflow-hidden bg-[#fffaf5] text-[#071739]">
      <section className="relative mx-auto w-full max-w-[1440px] px-6 pb-16 pt-10 sm:max-w-full sm:px-8 lg:px-10">
        <img
          src={allRecipesDetail}
          alt=""
          className="pointer-events-none absolute -right-[300px] -top-[118px] hidden h-[360px] w-[640px] object-cover object-center opacity-95 lg:block"
        />
        ...
        <div className="relative z-10 mb-4 grid gap-4 lg:grid-cols-[1fr_124px_250px]">
        ...
        <div className="relative z-10 mb-5 flex gap-3 overflow-x-auto pb-2">
        ...
        <div className="relative z-10 grid gap-6 xl:grid-cols-[250px_1fr]">
          <aside className="rounded-[8px] border border-[#efe7dd] bg-white shadow-[0_16px_38px_rgba(7,23,57,0.07)]">
              ...
              {filteredRecipes.map((recipe) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-4">
                      <h2 className="line-clamp-2 min-h-[52px] text-[21px] font-extrabold leading-[1.2] text-[#071739]">
                        {recipe.title}
                      </h2>

                      <div className="mt-3 flex flex-wrap items-center gap-5 text-sm font-semibold text-[#3d465a]">
